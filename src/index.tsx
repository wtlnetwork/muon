...
const installDependencies = callable<[boolean], { success: boolean; error?: string }>("install_dependencies");
...
function Content() {
  ...
  if (dependencies && (!dependencies["dnsmasq"])) {
        ...
        <PanelSectionRow>
          <ButtonItem
            ...
            onClick={async () => {
              ...
              const result = await installDependencies(missingDnsmasq);
              if (result.success) {
